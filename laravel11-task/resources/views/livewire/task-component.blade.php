        ...
        <table class="w-full table-auto">
            ...
            <tbody>
                ...
                <tr class="border-t border-gray-200">
                    <td class="px-4 py-2 text-sm text-gray-700 border border-gray-200">{{$task->title}}</td>
                    <td class="px-4 py-2 text-sm text-gray-700 border border-gray-200">{{$task->description}}</td>
        ...
        <div class="bg-white rounded-lg p-6 w-200">
            ...
            <form wire:submit.prevent="createTask">
                ...
                <div class="mb-4">
                    ...
                    <textarea id="description" wire:model="description" class="mt-1 px-3 py-2 border border-gray-300 rounded-md w-full" rows="4"></textarea>
                </div>
                ...
                <div class="flex justify-between">
                    ...
                    <!-- Botón Cerrar -->
                    <button type="button" @click="open = false" class="px-4 py-2 bg-gray-500 text-white rounded-md">
                        Cerrar
                    </button>
                </div>
            </form>
